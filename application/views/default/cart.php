	  ...
	  <div id="result">
			<table class="table table-bordered">
				...
				?>
				  ...
				  <div align="center">
				  <a href="" onclick="window.history.go(-1); return false;" class="btn btn-default"><span class="glyphicon glyphicon-backward"></span> Quay lại</a>
				  <a href="<?php echo base_url().$lang."/dat-hang" ?>" class="btn btn-default"><span class="glyphicon glyphicon-shopping-cart"></span> Đặt hàng</a>
				  </div>
	  </div>
	</div>
 </div>
