...
<div class="row" style="margin-top:-15px;">
	<div class="col-md-1" style="margin-top: 15px;">
		<a href="<?php echo base_url()."gcms/products/add"; ?>" class="btn btn-primary active">Thêm mới</a>
	</div>
	<div class="col-md-3">
	...
	<form action="" method="GET">
			<div class="form-group">
				<div class="col-sm-10 npdr">
					<input type="text" class="form-control searchds" name="keyword" id="keyword" placeholder="Nhập tên sản phẩm cần tìm." required>
				</div>
				<div class="col-sm-2">
...
<div class="col-md-4 col-md-pull-4 npd" align="left">
			<div class="form-group">
				<select class="form-control" id="numberpage" style="width: 20%;">
					...
					<option value="10" <?php if($this->session->userdata("limit") == 10) echo "selected"; else echo "selected"; ?>>10</option>
