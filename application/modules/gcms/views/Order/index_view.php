...
<!-- 	<div class="col-md-1" style="margin-top: 15px;">
		<a href="<?php echo base_url()."gcms/order/add"; ?>" class="btn btn-primary active">Thêm mới</a>
	</div> -->
	<div class="col-md-3">
...
<div class="table-responsive">
	...
	if ($data) {
		...
		foreach ( $data as $val ) {
			...
			echo "<td>$stt</td>";
			echo "<td><a class='editname' href='" . base_url () . "gcms/news/edit/$val[id]'>$val[fullname]</a></td>";
			...
			if ($val ['active'] == 1) {
				echo "<td><a class='btn btn-info active'>Đã xử lý</a></td>";
			} else {
				echo "<td><a class='btn btn-danger active'>Chưa xử lý</a></td>";
			}
			echo "<td><a href='" . base_url () . "gcms/order/view/$val[id]' class='editname'><span class='glyphicon glyphicon-eye-open'></span> Chi tiết</a></td>";
			echo "<td><a href='" . base_url () . "gcms/order/delete/$val[id]' onclick='return confirm(\"Bán có muốn xóa bản ghi này không?\");'><img src='".base_url()."public/gcms/img/garbage.png' alt='Delete' title='Delete' /></a></td>";
			echo "</tr>";
		}
	} else {
		echo "<tr class='active'><td align='center' colspan='9'>Không có dữ liệu.</td></tr>";
	}
	?>
	</tbody>
</table>
